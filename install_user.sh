...
print_help() {
    echo "Flight Planner User Installer"
    echo "Usage: $0 [OPTIONS]"
    echo ""
    echo "Options:"
    echo "  -h, --help         Show this help"
    echo ""
    echo "This installer installs Flight Planner to the user's home directory:"
...
echo "Installing Flight Planner to user directory: $USER_HOME/.local/"

# Check if running as root (should not)
if [[ $EUID -eq 0 ]]; then
    echo "Error: Do not run as root. This script installs to the user directory." >&2
    exit 1
fi
