...
pub fn setup_database() -> DatabasePool {
    use flight_planner::models::{Airport, NewAircraft, Runway};
    use flight_planner::schema::{aircraft as aircraft_schema, Airports as airports_schema, Runways as runways_schema};
