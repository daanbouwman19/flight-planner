...
fn create_test_history() -> Vec<ListItemHistory> {
    vec![
        ListItemHistory {
            ...
            departure_info: "John F. Kennedy International Airport (KJFK)".to_string(),
        ...
        ListItemHistory {
            ...
            departure_info: "Heathrow Airport (EGLL)".to_string(),
        ...
        ListItemHistory {
            ...
            departure_info: "Los Angeles International Airport (KLAX)".to_string(),
