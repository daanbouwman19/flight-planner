...
fn create_test_routes() -> Vec<ListItemRoute> {
    ...
    vec![
        ListItemRoute {
            ...
            departure_runway_length_str: "14511ft".to_string(),
            destination_runway_length: 12091,
            destination_runway_length_str: "12091ft".to_string(),
            route_length: 2475.5,
        ...
        ListItemRoute {
            ...
            departure_runway_length_str: "12091ft".to_string(),
            destination_runway_length: 12802,
            destination_runway_length_str: "12802ft".to_string(),
            route_length: 5440.2,
        ...
        ListItemRoute {
            ...
            departure_runway_length_str: "12802ft".to_string(),
            destination_runway_length: 14511,
            destination_runway_length_str: "14511ft".to_string(),
            route_length: 3459.1,
            aircraft_info: aircraft1_info.clone().into(),
