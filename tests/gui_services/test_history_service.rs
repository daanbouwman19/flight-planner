...
fn create_test_history() -> Vec<ListItemHistory> {
    vec![
        ListItemHistory {
            ...
            departure_airport_name: "John F. Kennedy International Airport".to_string(),
            arrival_icao: "KLAX".to_string(),
            arrival_airport_name: "Los Angeles International Airport".to_string(),
        ...
        ListItemHistory {
            ...
            departure_airport_name: "Heathrow Airport".to_string(),
            arrival_icao: "KJFK".to_string(),
            arrival_airport_name: "John F. Kennedy International Airport".to_string(),
        ...
        ListItemHistory {
            ...
            departure_airport_name: "Los Angeles International Airport".to_string(),
            arrival_icao: "EGLL".to_string(),
            arrival_airport_name: "Heathrow Airport".to_string(),
