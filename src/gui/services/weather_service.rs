...
/// A service for fetching weather data from the AVWX API.
#[derive(Clone)]
pub struct WeatherService {
    /// The API key for accessing the AVWX API.
    api_key: String,
    /// The base URL for the AVWX API.
    base_url: String,
    /// The reqwest client for making HTTP requests.
    client: reqwest::blocking::Client,
    /// A cache for storing METAR data to avoid redundant API calls.
